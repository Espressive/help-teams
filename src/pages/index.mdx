...
import logo from '../images/teams_logo.svg';
import teamsScreenshot from '../images/teams_app_screenshot.png';
...
<Image src={logo} alt="Teams Logo" width={200} height={200} objectFit={'contain'}/>
...
<Image src={teamsScreenshot} alt="Teams Screenshot" width={200} height={200} objectFit={'contain'}/>
